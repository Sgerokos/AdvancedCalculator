...
public class DemoCalculator {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 486, 720);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);
		
		textDisplay = new JTextField();
		textDisplay.setHorizontalAlignment(SwingConstants.RIGHT);
		textDisplay.setFont(new Font("Tahoma", Font.BOLD, 60));
		textDisplay.setBounds(10, 10, 430, 69);
		...
		btnbackspace.setFont(new Font("Dialog", Font.BOLD, 58));
		...
		//======================Row 2==============================
				...
				btn7.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						String EnterValue = textDisplay.getText() + btn7.getText();
				...
				btn8.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						String EnterValue = textDisplay.getText() + btn8.getText();
						textDisplay.setText(EnterValue);
					}
				});
				...
				btn9.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						String EnterValue = textDisplay.getText() + btn9.getText();
						textDisplay.setText(EnterValue);
					}
				});
				...
				btn4.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						String EnterValue = textDisplay.getText() + btn4.getText();
						textDisplay.setText(EnterValue);
					}
				});
				btn4.addActionListener(new ActionListener() {
				...
				btn5.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						String EnterValue = textDisplay.getText() + btn5.getText();
						textDisplay.setText(EnterValue);
					}
				});
				...
				btn6.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						String EnterValue = textDisplay.getText() + btn6.getText();
						textDisplay.setText(EnterValue);
					}
				});
              ...
              //======================Row 4========================
				...
				btn1.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						String EnterValue = textDisplay.getText() + btn1.getText();
						textDisplay.setText(EnterValue);
					}
				});
				btn1.addActionListener(new ActionListener() {
				...
				btn2.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						String EnterValue = textDisplay.getText() + btn2.getText();
						textDisplay.setText(EnterValue);
					}
				});
				...
				btn3.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						String EnterValue = textDisplay.getText() + btn3.getText();
						textDisplay.setText(EnterValue);
					}
				});
				...
				btn0.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						String EnterValue = textDisplay.getText() + btn0.getText();
						textDisplay.setText(EnterValue);
					}
				});
				btn0.addActionListener(new ActionListener() {
				...
				btnDot.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						String EnterValue = textDisplay.getText() + btnDot.getText();
						textDisplay.setText(EnterValue);
					}
				});
